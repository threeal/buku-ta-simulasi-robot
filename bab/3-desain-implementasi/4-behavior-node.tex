...
\subimport{4-behavior-node}{1-move-for-node.tex}
\subimport{4-behavior-node}{2-patrol-position-node.tex}
\subimport{4-behavior-node}{3-image-viewer-node.tex}
\subimport{4-behavior-node}{4-legs-teleop-node.tex}
\subimport{4-behavior-node}{5-pose-detector-node.tex}
\subimport{4-behavior-node}{6-rtabmap-node.tex}
