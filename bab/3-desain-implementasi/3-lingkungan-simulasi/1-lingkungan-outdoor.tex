...
Kedua \emph{include file} tersebut digunakan untuk memasukkan model \emph{ground plane} yang sudah disediakan oleh Gazebo dan model robot yang telah dibuat sebelumnya.
...
\lstinputlisting[
  language=XML,
  caption={Struktur SDFormat dari lingkungan simulasi outdoor.},
  label={lst:outdoorworldsdf}
]{kode/outdoor_world_sdf.xml}

Setelah \emph{file} SDFormat dibuat,
  hasil yang didapatkan setelah simulator dijalankan tampak seperti pada gambar \ref{fig:lingkunganoutdoor}.
...
\begin{figure} [ht]
  ...
  \caption{Tampilan lingkungan simulasi outdoor pada Gazebo.}
