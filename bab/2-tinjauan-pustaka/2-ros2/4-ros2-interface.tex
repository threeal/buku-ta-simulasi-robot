...
\begin{sidewaysfigure}
  \centering
  \includegraphics[width=0.9\textwidth,keepaspectratio]{gambar/diagram-interface-ros2.png}
...
\lstinputlisting[
  style=code,
  caption={Contoh \emph{file msg} yang mendeskripsikan \emph{interface} untuk suatu \emph{topic}.},
